...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        KC_LCTL,   KC_A,    KC_S,    KC_D,    KC_F,   KC_G,    KC_H,    KC_J,   KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_NO,     KC_ENT,  KC_END,
        KC_LSHIFT, KC_Z,    KC_X,    KC_C,    KC_V,   KC_B,    KC_N,    KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_NO,   KC_RSHIFT, KC_UP,
        KC_LCTL,   KC_LGUI, KC_LALT, KC_LCTL, KC_SPC, KC_ENT,  KC_NO,   KC_NO,  KC_RALT, KC_RGUI, MO(1)  ,          KC_LEFT,   KC_DOWN, KC_RIGHT
    ),

    [1] = LAYOUT(
        RESET,            _______, _______, _______, _______, _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU, _______,
